...
public class TutorialAdvancedSorting : ITabItem {
    ...
    private const string AdvancedTech = "SortaBettah evaluates sorting rules in a specific order, " +
                                        ...
                                        "You can use this characteristic of SortaBettah to define generalized sorting rules at the top of the list, and more specific sorting rules at the bottom of the list, " +
